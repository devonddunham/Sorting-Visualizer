...
export function GenerateAnimationArray(
  ...
  switch (selected) {
    case "bubble":
      BubbleSort(isSorting, arr, runAnimation);
      break;
    case "insertion":
      InsertionSort(isSorting, arr, runAnimation);
      break;
    case "merge":
      MergeSort(isSorting, arr, runAnimation);
      break;
    case "quick":
      QuickSort(isSorting, arr, runAnimation);
      break;
    case "selection":
      SelectionSort(isSorting, arr, runAnimation);
      break;
    default:
      break;
  }
